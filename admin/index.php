...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
      <div style="flex: 1; width: 100%">
        <a class="navbar-brand font-weight-bold text-light ml-3" href="/spkrinaldy/admin/index.php?modul=home" >
          <img class="mr-3"src="../images/logo.jpg" width="120" height="auto" alt=""> Promosi Jabatan
        </a>
        <a style="float: right;" href="#"  class="btn btn-primary mt-2" data-toggle="modal" data-target="#user"><i class="fas fa-user mr-2  fa-lg"></i><?php echo $nama;?></a>
      </div>
          ...
          <div class="modal-dialog modal-sm mr-4" style="float: right; width: 15%;">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <center>
                  <p class="align-center font-weight-bold"><i class="fas fa-user mr-2 mt-2 fa-4x"></i><br><?php echo $nama;?></p>
                </center>
                <div style="flex: 1; width: 100%">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                  <a style="float: right;" href="/spkrinaldy" type="button" class="btn btn-primary">Logout</a>
                </div>
              </div>
              <div class="modal">
              </div>
...
<div class="row no-gutters">
    <div class="col-md-2 bg-light pr-3 pt-4">
        <ul class="nav flex-column ml-3">
          <li class="nav-item">
            <a class="nav-link active text-secondary font-weight-bold" href="?modul=dashboard"><i class="fas fa-home fa-lg mr-3"></i>Dashboard</a><hr class=" bg-light">
          </li>
          <li class="nav-item">
            <a class="nav-link text-secondary font-weight-bold" href="?modul=karyawan"><i class="fas fa-users fa-lg mr-3"></i>Data Alternatif</a><hr class=" bg-light">
          </li>
          <li class="nav-item">
            <a class="nav-link text-secondary font-weight-bold" href="?modul=kriteria"><i class="fas fa-database fa-lg mr-3"></i>Data Kriteria</a><hr class=" bg-light">
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link text-secondary font-weight-bold" href="#">tests</a><hr class=" bg-light">
          </li>
        </ul>
    </div>
    <?php
...
<div class="footer bg-light pt-3">
  <center><p>Copyright @ 2020 Muhammad Rinaldy</p></center>
</div>
